...
__kernel void kernel_tweak_uv(
    ...
    if (ix < width && iy < height) {
        ...
        apply_basic_tweak_uv(&u0, &v0, saturation, hue_sin, hue_cos, hue_limit, hue_min, hue_max, clamp_min, clamp_max);
        apply_basic_tweak_uv(&u1, &v1, saturation, hue_sin, hue_cos, hue_limit, hue_min, hue_max, clamp_min, clamp_max);
        apply_basic_tweak_uv(&u2, &v2, saturation, hue_sin, hue_cos, hue_limit, hue_min, hue_max, clamp_min, clamp_max);
        apply_basic_tweak_uv(&u3, &v3, saturation, hue_sin, hue_cos, hue_limit, hue_min, hue_max, clamp_min, clamp_max);
