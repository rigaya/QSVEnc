...
static void __forceinline convert_yuy2_to_nv12_simd(void **dst, void **src, int width, int src_y_pitch_byte, int src_uv_pitch_byte, int dst_y_pitch_byte, int height, int *crop) {
...
#pragma warning (push)
#pragma warning (disable: 4100)
static void __forceinline convert_yuy2_to_nv12_i_simd(void **dst, void **src, int width, int src_y_pitch_byte, int src_uv_pitch_byte, int dst_y_pitch_byte, int height, int *crop) {
	const int crop_left   = crop[0];
	const int crop_up     = crop[1];
	const int crop_right  = crop[2];
	const int crop_bottom = crop[3];
...
static void __forceinline convert_yv12_to_nv12_simd(void **dst, void **src, int width, int src_y_pitch_byte, int src_uv_pitch_byte, int dst_y_pitch_byte, int height, int *crop) {
	const int crop_left   = crop[0];
	const int crop_up     = crop[1];
	const int crop_right  = crop[2];
	const int crop_bottom = crop[3];
...
static void __forceinline convert_yv12_to_yv12_simd(void **dst, void **src, int width, int src_y_pitch_byte, int src_uv_pitch_byte, int dst_y_pitch_byte, int height, int *crop) {
	const int crop_left   = crop[0];
	const int crop_up     = crop[1];
	const int crop_right  = crop[2];
	const int crop_bottom = crop[3];
...
#pragma warning (push)
#pragma warning (disable: 4100)
static void __forceinline convert_rgb3_to_rgb4_simd(void **dst, void **src, int width, int src_y_pitch_byte, int src_uv_pitch_byte, int dst_y_pitch_byte, int height, int *crop) {
	const int crop_left   = crop[0];
	const int crop_up     = crop[1];
	const int crop_right  = crop[2];
	const int crop_bottom = crop[3];
...
#pragma warning (push)
#pragma warning (disable: 4100)
static void __forceinline convert_rgb4_to_rgb4_simd(void **dst, void **src, int width, int src_y_pitch_byte, int src_uv_pitch_byte, int dst_y_pitch_byte, int height, int *crop) {
	const int crop_left   = crop[0];
	const int crop_up     = crop[1];
	const int crop_right  = crop[2];
	const int crop_bottom = crop[3];
