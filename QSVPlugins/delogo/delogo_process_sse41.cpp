...
static __declspec(noinline) void process_delogo_sse41(mfxU8 *dst, const mfxU32 dst_pitch, mfxU8 *buffer,
...
mfxStatus DelogoProcessSSE41::Process(DataChunk *chunk, mfxU8 *pBuffer) {
	...
	process_delogo_sse41(m_pOut->Data.Y,  m_pOut->Data.Pitch, pBuffer, m_pIn->Data.Y,  m_pIn->Data.Pitch, m_pIn->Info.CropW, 0, m_pIn->Info.CropH,      &m_sData[0]);
	process_delogo_sse41(m_pOut->Data.UV, m_pOut->Data.Pitch, pBuffer, m_pIn->Data.UV, m_pIn->Data.Pitch, m_pIn->Info.CropW, 0, m_pIn->Info.CropH >> 1, &m_sData[1]);
