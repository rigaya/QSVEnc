...
これから作成する新しいバージョンのユーザーに影響のある更新履歴を作成するタスクである。
なるべくひとつの更新については、git logのメッセージを使用して、簡潔に記載する。
ただし、わかりにくい場合は少し改変や追記を行う。

すでに更新内容の記載がある場合は、重複しないように更新する。
